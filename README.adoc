...
a|
link:00._Course_Material/01._Assignments/02._First_Server/REST_API_Part_I.md[Animals REST API - Part I]
...
link:00._Course_Material/01._Assignments/03._Loop_Methods/REST_API_Part_II.md[Animals REST API - Part II]
